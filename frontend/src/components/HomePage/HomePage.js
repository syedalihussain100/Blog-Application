      ...
      <div className="relative container px-4   mx-auto">
        <div className="flex flex-wrap items-center -mx-4 mb-10 2xl:mb-14">
          <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
            ...
            <a
              className="inline-block px-12 py-3 text-lg text-white font-bold bg-blue-500 hover:bg-blue-600 rounded-full transition duration-200"
              href="/"
            >
              Stay Connected
            </a>
          ...
          <div className="w-full lg:w-1/2 px-4">
            <img className="w-full" src={posterImage} alt={posterImage} />
          </div>
        </div>
      </div>
    </section>
