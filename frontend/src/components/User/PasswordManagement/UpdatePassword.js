...
import { updateUserPasswordAction } from "../../../redux/Slices/users/usersSlices";
...
const UpdatePassword = () => {
  ...
  const { loading, appErr, serverErr, passwordUpdated,userAuth } = storeData;
  ...
  if(passwordUpdated) return navigate(`/profile/${userAuth?._id}`)
    ...
    <div className="min-h-screen bg-gray-700  flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          {appErr || serverErr ? (
            <h2 className="text-center text-red-600 text-lg">
