...
export default function Profile() {
  ...
  const isLogin = userAuth?._id === profile?._id;

  return (
    <>
      <div className="min-h-screen bg-green-600 ">
        {ProfileAppErr || ProfileServerErr ? (
          <h2 className="text-yellow-400 text-2xl flex justify-center items-center">
            {ProfileServerErr?.message} {ProfileAppErr}
          </h2>
        ) : (
                          ...
                          <div className="mt-6 sm:flex-1 sm:min-w-0 sm:flex sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                            <div className=" flex flex-col 2xl:block mt-10 min-w-0 flex-1">
                              ...
                              <div className="flex items-center  mb-2">
                                ...
                                <div className="pl-2">
                                  {/* {userprofileDetails?.viewedBy?.length} */}
